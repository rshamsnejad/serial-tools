...
_DEBUG_PRINT echo "PROMPT_DEVICE=$PROMPT_DEVICE"
_DEBUG_PRINT echo "READ_PROMPT=$READ_PROMPT"
_DEBUG_PRINT echo "READ_VARIABLE=$READ_VARIABLE"
_DEBUG_PRINT echo "SEND_COMMAND=$SEND_COMMAND"
_DEBUG_PRINT echo "NOTICE=$NOTICE"
_DEBUG_PRINT echo "PROMPT_COMMAND=$PROMPT_COMMAND"
